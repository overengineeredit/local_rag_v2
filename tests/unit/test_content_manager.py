...
class TestContentManager:
    ...
    def test_ingest_file_not_found(self):
        ...
        with patch('guide.content_manager.Path') as mock_path:
            ...
            result = cm.ingest_file("/nonexistent/file.txt")
    ...
    def test_ingest_file_error_handling(self):
        ...
        with patch('guide.content_manager.Path') as mock_path:
            ...
            result = cm.ingest_file("/some/file.txt")
    ...
    def test_ingest_directory_not_directory(self):
        ...
        with patch('guide.content_manager.Path') as mock_path:
            ...
            result = cm.ingest_directory("/not/a/directory")
    ...
    def test_logging_directory_processing(self, mock_logger):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            mock_logger.info.assert_called_with(f"Processed directory {temp_path.name}: 1 total documents")
