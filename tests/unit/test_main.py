...
class TestThermalMonitor:
    ...
    def test_read_temperature_success(self):
        ...
        with (
            patch.object(ThermalMonitor, "_discover_thermal_zones"),
...
class TestLoggingSetup:
    ...
    def test_setup_logging_with_json_format(self):
        ...
        from guide.main import JSONFormatter, setup_logging
...
class TestCreateApp:
    ...
    def test_create_app_success(self):
        ...
        with (
            patch("guide.main.setup_logging"),
...
class TestMain:
    ...
    def test_main_success(self):
        ...
        with (
            patch("guide.main.create_app") as mock_create_app,
            patch("guide.main.config") as mock_config,
