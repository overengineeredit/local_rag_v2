...
class LocalRAGCLI:
    ...
    def status(self, verbose: bool = False) -> None:
        ...
        try:
            ...
            console.print(f"Service: {data.get('service', 'unknown')} v{data.get('version', 'unknown')}")
            console.print()
...
def main() -> None:
    ...
    status_parser.add_argument("--verbose", "-v", action="store_true", help="Show detailed component information")
